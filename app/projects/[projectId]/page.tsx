    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-2xl mx-auto py-12 px-4 text-center">
          ...
          <Link href="/?tab=opportunities" className="mt-4 inline-block text-blue-600 hover:underline">
      ...
      <div className="max-w-3xl mx-auto py-8 px-4">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 md:p-8">
          <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
            ...
            <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-medium shrink-0">
          ...
          <div className="flex flex-wrap gap-2 pt-2 border-t border-gray-100">
            {currentUserId == null ? (
              ...
              <button
                ...
                className="w-full sm:w-auto py-3 px-6 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-semibold min-h-[48px]"
              >
                Express interest
              </button>
            )}
          ...
          >
            ...
            <div className="flex justify-end gap-2">
              ...
              <button
                ...
                disabled={interestSubmitting}
                className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 font-semibold min-h-[44px]"
              >
